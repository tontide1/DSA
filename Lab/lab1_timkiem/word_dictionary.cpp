...
void cap_nhat_nghia(int so_luong, W tu[], const char x[256], const char y[512]) {
    int vi_tri = tim_kiem(so_luong, tu, x);
    if (vi_tri == -1) {
        printf("Khong tim thay tu can cap nhat!\n");
        return;
    }
    ...
    printf("Nghia cua tu '%s' da duoc cap nhat.\n", x);
